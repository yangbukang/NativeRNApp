...
static const BOOL    CSToastDisplayShadow       = NO;//mxy modify 阴影
...
- (void)makeToast:(NSString *)message duration:(NSTimeInterval)duration  position:(id)position title:(NSString *)title image:(UIImage *)image {
    UIView *toast = [self viewForMessageDK:message title:title image:image];
    [self showToast:toast duration:duration position:position];  
}
...
- (UIView *)viewForMessageDK:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    // sanity
    ...
    //mxy modify
    wrapperView.backgroundColor = [UIColor colorWithRed:96.0/255.0 green:96.0/255.0 blue:96.0/255.0 alpha:1.0];
